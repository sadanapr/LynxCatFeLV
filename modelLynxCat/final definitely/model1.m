function model1()
    ...
    plot(t,X(3,:),'b','DisplayName','Susceptible Cats');
    plot(t,X(4,:),'c','DisplayName','Infected Cats');
    plot(t,X(5,:),'m','DisplayName','Recovered Cats');
    plot(t,X(6,:),'g','DisplayName','Rabbits');
    xlim([0 365*13])
    xlabel('Time (days)')
    ylabel('Population')
    hold off;
    ...
    %plot C 
    figure
    plot(t,X(3,:),'k','DisplayName','Susceptible Cats');
    hold on;
    plot(t,X(4,:),'r','DisplayName','Infected Cats');
    plot(t,X(5,:),'m','DisplayName','Recovered Cats');
    plot(t,X(3,:) + X(4,:) + X(5,:),'b','DisplayName','Total Cats');
    xlim([0 365*13])
    xlabel('Time (days)')
    ylabel('Population')
    hold off;
    ...
    hold on;
    plot(t,X(2,:),'r','DisplayName','Infected Lynx');
    plot(t,X(1,:) + X(2,:),'b','DisplayName','Total Lynx');
    xlim([0 365*13])
    xlabel('Time (days)')
    ylabel('Population')
    hold off;
    ...
    %plot LCR
    figure
    plot(t,X(1,:) + X(2,:),'r','DisplayName','Lynx');
    hold on;
    plot(t,X(3,:)+X(4,:)+X(5,:),'b','DisplayName','Cats');
    plot(t,X(6,:),'g','DisplayName','Rabbits');
    xlim([0 365*13])
    xlabel('Time (days)')
    ylabel('Population')
