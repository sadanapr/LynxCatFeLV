function model1()
    ...
    param.S_C0 = 0.95*param.C0;
    param.I_C0 = 0.05*param.C0;
    param.R_C0 = 0;

    param.R0 = 700;

%     param.alpha_LC = 0.0026; %ESTIMATION
%     param.e_LR = 0.0028; %OK 
%     param.e_CR = 0.001; %OK
%     param.e_LC = 0.0001; %ESTIMATION
%     param.beta_L = 0.1;
%     param.beta_C = 0.027; %OK
%     param.beta_CL = 0.95 * param.alpha_LC/param.L0; %ESTIMATION = 0.000082
%     param.gamma_L = 0.00046; %OK 
%     param.rho_C = 0.0018; %OK 
%     param.delta_L = 0.0038; %OK
%     param.delta_C = 0.0015; %OK
%     param.q_L = 0.036; %ESTIMATION
%     param.p_C = 0.07; %OK
%     param.p_L = 0.01; %OK 
%     param.x_L = 0.14; %OK
%     param.x_C = 0.002; %BOF 
%     param.y_R = 6.1; %OK
    ...
    param.e_LR = 0.12; %OK  0.12
    param.e_CR = 0.24; %ESTIMATION 0.24
    param.e_LC = 0.01; %ESTIMATION 0.01
    param.beta_L = 0.07; %ESTIMATION 
    param.beta_C = 0.027; %OK 0.027
    param.beta_CL = 0.95 * param.alpha_LC; %ESTIMATION 
    param.gamma_L = 0.00046; %OK 
    param.rho_C = 0.0018; %OK 
    param.delta_L = 0.0038; %OK
    param.delta_C = 0.009; %OK 0.0015
    param.q_L = 0.3; %ESTIMATION 0.036
    param.p_C = 0.5; %OK 0.07; 0.5
    param.p_L = 0.5; %OK 0.01; 0.5
    param.x_L = 0.12; %OK 0.14
    param.x_C = 0.1; %BOF 0.002; 0.1
...
%     plot L
    ...
    sensitivty = ((-4.1112 + t(find(L < 1,1)))/0.1)*(0.07/4.1112)
%     %plot LCR
%     figure
